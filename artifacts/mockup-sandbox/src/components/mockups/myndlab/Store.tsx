      ...
      <main style={{ flex: 1, padding: "40px 48px 80px", overflowY: "auto", maxWidth: "1040px", margin: "0 auto", width: "100%" }}>
        ...
        <div style={{ marginBottom: "28px" }}>
          ...
          <p style={{ fontSize: "15px", color: "var(--mn-text-muted)", margin: 0, lineHeight: 1.55, maxWidth: "640px" }}>
            <strong style={{ color: "var(--mn-text)", fontWeight: 600 }}>Not an app store.</strong> Every app installs straight from a link — Add to Home Screen, works offline, no App Store queue. Built by GCC founders using MyndLab, browsable by category and country.
          </p>
        </div>
